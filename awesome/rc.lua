...
screen.connect_signal("property::geometry", function(s)
    ...
    if beautiful.wallpaper then
        ...
        gears.wallpaper.maximized("/home/user/Desktop/delete/bluefox.jpg", s, true)
    end
end)
...
globalkeys = mytable.join(
    ...
    awful.key({ modkey, "Shift"   }, "Return", function () awful.spawn("env XDG_CURRENT_DESKTOP=GNOME gnome-control-center") end,
              {description = "open a terminal", group = "launcher"}),
...
--    "x-terminal-emulator",
      ...
      "xinput set-prop 'ELAN0522:01 04F3:31C3 Touchpad' 'libinput Tapping Enabled' 1", -- enable touchpad tapping
}
if autorun then
